...
function [lh] = spawn_process(in_path, in_cmdline, in_wd, in_cmdshow, in_stdinscript, in_stdoutcallback)
...
lh = process.addlistener('OutputDataReceived', in_stdoutcallback);
